...
class AddEntity extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
       ...
       $builder->add('contact');
        ...
        $builder->add('type', 'choice', array(
            'choices' => array('Client' => 'Client', 'Prospect' => 'Prospect', 'Concurrent' => 'Concurrent',
                'Fournisseur' => 'Fournisseur', 'Associé'=>'Associé', 'Autre' => 'Autre'),
    ...
    {
        return array(
            'data_class' => 'CRM\PagesBundle\Entity\entities'
        );
    }
    ...
    {
        return 'crm_pagesbundle_entities';
    }
